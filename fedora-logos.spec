...
install -p -m 644 bootloader/serene.icns $RPM_BUILD_ROOT%{_datadir}/pixmaps/bootloader
...
#    ln -s ../../../hicolor/$size/apps/serene-logo-icon.png icon-panel-menu.png
...
#nstall -p -m 644 icons/hicolor/scalable/apps/xfce4_xicon1_classic.svg $RPM_BUILD_ROOT%{_datadir}/icons/hicolor/scalable/apps
...
%files
   ...
   /usr/share/anaconda/pixmaps/anaconda_header_classic.png
